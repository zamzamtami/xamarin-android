...
namespace xamarin::android::internal {
	...
	private:
		...
		bool gather_bundled_assemblies_from_apk (const char* apk, size_t total_apk_count, monodroid_should_register should_register);
		...
		bool zip_load_entries (int fd, const char *apk_name, size_t total_apk_count, monodroid_should_register should_register);
